...
# 2004-09-10 fl   Added fonts mode handling
# 2006-06-19 fl   Added fonts bearing support (getmask2)
#
...
class ImageDraw:
    ...
    def getfont(self):
        """
        Get the current default fonts.

        :returns: An image fonts."""
        if not self.font:
            # FIXME: should add a fonts repository
