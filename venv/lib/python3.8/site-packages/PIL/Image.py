...
class Image:
    ...
    * :py:func:`~PIL.Image.frombytes`
    ...
    def close(self):
        ...
        This function is only required to close image that have not
    ...
    def quantize(self, colors=256, method=None, kmeans=0, palette=None, dither=1):
        ...
        if palette:
            ...
            if self.mode != "RGB" and self.mode != "L":
                raise ValueError(
                    "only RGB or L mode image can be quantized to a palette"
                )
    ...
    def paste(self, im, box=None, mask=None):
        ...
        image (in the latter case, the alpha band is used as mask).
